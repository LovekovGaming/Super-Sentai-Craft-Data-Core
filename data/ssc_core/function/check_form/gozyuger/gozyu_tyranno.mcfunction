advancement revoke @s only ssc_core:gozyuger/gozyu_tyranno
function #ssc_core:pre_check/gozyuger/gozyu_tyranno
execute unless items entity @s armor.feet *[minecraft:custom_data] run function #ssc_core:first_change/gozyuger/gozyu_tyranno

scoreboard players operation Form_Difference ssc.form1n = @s ssc.form1n
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"supersentaicraft:gozyu_tyranno_ring"}] run scoreboard players set @s ssc.form1n 0
...
scoreboard players operation Form_Difference ssc.form1n -= @s ssc.form1n
function #ssc_core:post_check/gozyuger/gozyu_tyranno
