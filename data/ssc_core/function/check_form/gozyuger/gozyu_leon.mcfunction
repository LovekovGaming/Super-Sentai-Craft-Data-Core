advancement revoke @s only ssc_core:gozyuger/gozyu_leon
function #ssc_core:pre_check/gozyuger/gozyu_leon
execute unless items entity @s armor.feet *[minecraft:custom_data] run function #ssc_core:first_change/gozyuger/gozyu_leon

scoreboard players operation Form_Difference ssc.form1n = @s ssc.form1n
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"supersentaicraft:gozyu_leon_ring"}] run scoreboard players set @s ssc.form1n 0
...
scoreboard players operation Form_Difference ssc.form1n -= @s ssc.form1n
function #ssc_core:post_check/gozyuger/gozyu_leon
