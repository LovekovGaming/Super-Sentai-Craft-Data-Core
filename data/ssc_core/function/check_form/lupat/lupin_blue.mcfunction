advancement revoke @s only ssc_core:lupat/lupin_blue
function ssc_core:preprocess_belt
function #ssc_core:pre_check/lupat/lupin_blue
execute unless items entity @s armor.feet *[minecraft:custom_data] run function #ssc_core:first_change/lupat/lupin_blue
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"supersentaicraft:blue_dial_fighter"}] run scoreboard players set @s ssc.form1n 0
...
scoreboard players operation Form_Difference ssc.form1n -= @s ssc.form1n
scoreboard players operation Form_Difference ssc.form2n -= @s ssc.form2n
function #ssc_core:post_check/lupat/lupin_blue
